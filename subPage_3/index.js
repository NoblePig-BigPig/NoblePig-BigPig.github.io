...
void main() {
  ...
  var cards = ["\u8349\u7CBE\u9748", "\u706B\u7CBE\u9748", "\u5149\u7CBE\u9748", "\u571F\u7CBE\u9748", "\u6C34\u7CBE\u9748", "\u91D1\u7CBE\u9748", "\u91D1\u7CBE\u97482", "\u95C7\u7CBE\u9748", "\u98A8\u7CBE\u9748", "\u8349\u4EBA"];
  function randomCard() {
  ...
  function createUI() {
    ...
    let texture = textureLoader.load(
      ...
      () => console.log("\u5716\u7247\u52A0\u8F09\u6210\u529F"),
      void 0,
      (error) => console.error("\u5716\u7247\u52A0\u8F09\u5931\u6557", error)
    );
    ...
    menu.style.height = "calc(100% - 20px)";
    menu.style.backgroundColor = "rgba(190, 37, 37, 0.5)";
    menu.style.color = "white";
    menu.style.padding = "10px";
    menu.innerHTML = "<h3>\u6211\u7684\u5361\u7C3F</h3><p>\u958B\u59CB\u62BD\u5361</p><p>\u641C\u5C0B\u670B\u53CB\u7684\u5361\u7C3F</p>";
    document.body.appendChild(menu);
    const mainScreen = document.createElement("div");
    mainScreen.style.position = "absolute";
    mainScreen.style.top = "10px";
    mainScreen.style.left = "220px";
    mainScreen.style.width = "calc(100% - 240px)";
    mainScreen.style.height = "calc(100% - 50px)";
    mainScreen.style.backgroundColor = "rgba(0, 0, 0, 0.3)";
    mainScreen.style.color = "white";
    mainScreen.style.padding = "10px";
    mainScreen.innerHTML = "<h3>\u751F\u6210\u7CBE\u9748</h3><p>\u8ACB\u5728\u756B\u9762\u4E0A\u7B49\u5F85\u81F3\u5C1110\u5206\u9418\uFF0C\u5C31\u53EF\u4EE5\u6309\u4E0B\u6309\u9215\u53EC\u559A\u751F\u7269\u3002(\u6BCF\u5929\u9650\u5236\u53EC\u559A\u6B21\u6578)</p>";
    document.body.appendChild(mainScreen);
    const drawCardButton = document.createElement("button");
    drawCardButton.innerText = "\u958B\u59CB\u62BD\u5361";
    drawCardButton.style.position = "absolute";
    drawCardButton.style.bottom = "200px";
    drawCardButton.style.left = "50%";
    drawCardButton.style.transform = "translateX(-50%)";
    drawCardButton.style.padding = "10px 20px";
    drawCardButton.style.backgroundColor = "#f1c40f";
    drawCardButton.style.color = "white";
    drawCardButton.style.border = "none";
    drawCardButton.style.borderRadius = "5px";
    ...
    drawCardButton.addEventListener("click", () => {
      ...
      isGenerating = true;
      plane.visible = false;
      drawCardButton.style.backgroundColor = "gray";
      drawCardButton.innerText = "\u6B63\u5728\u751F\u6210\u4E2D...";
      triggerCardDrawEffect();
      setTimeout(() => {
        const newTexture = textureLoader.load(
          ...
          () => console.log("\u65B0\u5716\u7247\u52A0\u8F09\u6210\u529F"),
          void 0,
          (error) => console.error("\u65B0\u5716\u7247\u52A0\u8F09\u5931\u6557", error)
        );
        plane.material.map = newTexture;
        plane.material.needsUpdate = true;
        plane.visible = true;
        isGenerating = false;
        drawCardButton.innerText = "\u82B1\u8CBB100\u7F8E\u91D1\u518D\u62BD\u4E00\u6B21";
        drawCardButton.style.backgroundColor = "#f1c40f";
      }, 500);
    });
    function triggerCardDrawEffect() {
    ...
    function triggerParticleEffect() {
      ...
      const animateParticles = () => {
        ...
        for (let i = 0; i < particleCount; i++) {
          const idx = i * 3;
          const dx = target[idx] - positions2[idx];
          const dy = target[idx + 1] - positions2[idx + 1];
          const dz = target[idx + 2] - positions2[idx + 2];
          velocities[idx] += dx * 0.02;
          velocities[idx + 1] += dy * 0.02;
          velocities[idx + 2] += dz * 0.02;
          positions2[idx] += velocities[idx];
          positions2[idx + 1] += velocities[idx + 1];
          positions2[idx + 2] += velocities[idx + 2];
        }
        particleSystem.geometry.attributes["position"].needsUpdate = true;
      };
      const cleanup = setInterval(animateParticles, 16);
      setTimeout(() => {
